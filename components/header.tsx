	...
	return (
		...
		>
			<div className="container-wide flex items-center justify-between h-16 px-5 sm:px-6">
				...
				>
					<span className="font-display text-2xl font-medium tracking-tight text-(--color-text)">
						Dumavena
					</span>
					<span className="hidden sm:inline text-lg uppercase tracking-[0.2em] text-(--color-text-muted) mt-1">
						LLC
					</span>
				</Link>

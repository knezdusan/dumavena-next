...
export function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-[100svh] flex items-start overflow-hidden grain pt-24 pb-20 md:items-center md:py-0"
    >
      {/* Ambient glow */}
      <div
        ...
        <div className="grid md:grid-cols-[1.2fr_1fr] gap-12 items-center">
          <div className="max-w-3xl">
            ...
            <motion.h1
              ...
              className="font-display text-[clamp(2.5rem,7vw,5rem)] leading-[1.05] tracking-tight text-(--color-text)"
            >
      ...
      >
        ...
        <div className="w-px h-12 bg-gradient-to-b from-(--color-text-muted) to-transparent" />
      </motion.div>
    </section>
  );
}
